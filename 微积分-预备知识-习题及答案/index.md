...
7. *$ y = -2^x + 3 $*
   ...
   * $$
     \begin{gather*}
     -2^x + 3 = 0 \quad -2^x = -3 \quad 2^x = 3 \quad x = log_2(3)
     \\\ \\\
     y = -2^0 + 3 = -1 + 3 = 2
     \end{gather*}
     $$
...
8. *$ y = e^x + 3 $*
   ...
   * $$
     \begin{gather*}
     0 = e^x + 3 \quad e^x = -3 \quad \text{因为}e^x\text{的值恒为正，所以没有x截距，此方程无意义}
     \\\ \\\
     y = e^0 + 3 = 1 + 3 = 4
     \end{gather*}
     $$
...
9. *$ y = 3 \cdot e^{-x} - 2 $*
   ...
   * $$
     \begin{gather*}
     0 = 3 \cdot e^{-x} -2 \quad \frac{1}{e^{x}} = \frac{2}{3} \quad e^x = \frac{3}{2} \quad x = \ln{ \frac{3}{2}}
     \\\ \\\
     y = 3 \cdot e^0 - 2 = 3 \cdot 1 - 2 = 1
     \end{gather*}
     $$
...
10. *$y = -2^{-x} - 1$*
    ...
    * $$
      \begin{gather*}
      0 = -2^{-x} - 1 \quad 1 = -2^{-x} \quad 2^{-x} = -1 \quad \text{因为}2^{-x}\text{值恒为证数，所以没有x截距，此方程无意义}
      \\\ \\\
      y = -2^0 - 1 = -1 - 1 = -2
      \end{gather*}
      $$
...
11. *$ 9^{2x}，底为 3 $*
    $$
    9^{2x} \Rightarrow 3^{2 \cdot {2x}} \Rightarrow 3^{4x}
    $$

12. *$ 16^{3x}，底为 2 $*
    $$
    16^{3x} = 2^{4 \cdot 3x} = 2^{12x}
    $$

13. *$ (\frac{1}{8})^{2x}，底为 2 $*
    $$
    (\frac{1}{8})^{2x} = 2^{-3 \cdot 2x} = 2^{-6x}
    $$

14. *$ (\frac{1}{27})^x，底为 3 $*
    $$
    (\frac{1}{27})^x = 3^{-3 \cdot x} = 3^{-3x}
    $$
...
11. *$ f(x) = x^2 + 1，x \geq 0 $*
    $$
    \begin{gather*}
    y = x^2 + 1，x \geq 0
    \\\ \\\
    x = y^2 + 1  \quad \text{x，y交换}
    \\\ \\\
    x - 1 = y^2
    \\\ \\\
    y = \pm \sqrt{x - 1}
    \\\ \\\
    \text{原函数的定义域是} x \geq 0 \text{，所以这意味反函数的值域必须是} y \geq 0
    \\\ \\\
    y = \sqrt{x - 1} \quad \Rightarrow \quad f^{-1}(x) = \sqrt{x - 1}
    \end{gather*}
    $$
...
12. *$ f(x) = x^2，x \leq 0 $*
    ...
    y = x^2, x \leq 0
    \\\ \\\
    x = y^2  \quad \text{x，y交换}
    \\\ \\\
    y = \pm \sqrt{x}
    \\\ \\\
    \text{原函数的定义域是} x \leq 0 \text{，所以这意味反函数的值域必须是} y \leq 0
    \\\ \\\
    y = -\sqrt{x} \quad \Rightarrow \quad f^{-1}(x) = -\sqrt{x}
    \end{gather*}
    $$
...
14. *$ f(x) = x^2 - 2x + 1，x \geq 1 $*
    $$
    \begin{gather*}
    f(x) = x^2 - 2x + 1，x \geq 1
    \\\ \\\
    y = x^2 - 2x + 1
    \\\ \\\
    y = (x - 1)^2
    \\\ \\\
    x = (y - 1)^2 \quad \text{x，y交换}
    \\\ \\\
    y - 1 = \pm \sqrt{x}
    \\\ \\\
    y = \pm \sqrt{x} + 1
    \\\ \\\
    \text{原函数的定义域是} x \geq 1 \text{，所以这意味反函数的值域必须是} y \geq 1
    \\\ \\\
    y = \sqrt{x} + 1 \quad \Rightarrow \quad f^{-1}(x) = \sqrt{x} + 1
    \end{gather*}
    $$
    
15. *$ f(x) = (x + 1)^2，x \geq 1 $*
    $$
    \begin{gather*}
    f(x) = (x + 1)^2，x \geq 1
    \\\ \\\
...
16. *$ f(x) = x^{2/3}，x \geq 0 $*
    ...
    \text{原函数的定义域是} x \geq 0 \text{，所以这意味反函数的值域必须是} y \geq 0
    \\\ \\\
    y = \sqrt{x}^3 \quad \Rightarrow \quad f^{-1}(x) = \sqrt{x}^3
    \end{gather*}
    $$
...
18. *$ f(x) = 5 - 4x $*
    ...
    *求 $ f^{-1} $*
    ...
    x = -\frac{y - 5}{4}
    \\\ \\\
    y = -\frac{x - 5}{4} \quad \text{交换x，y}
    \\\ \\\
    \quad f^{-1}(x) =  -\frac{x - 5}{4} = \frac{5 - x}{4}
    \end{gather*}
    $$
    *验证 $ f(f^{-1}(x)) = f^{-1}(f(x)) $*
    $$
    \begin{gather*}
    f(f^{-1}(x)) = f(\frac{5 - x}{4}) = 5 - 4(\frac{5 - x}{4})= 5 - (5 - x) = x 
    \\\ \\\
    f^{-1}(f(x)) = f^{-1}(5 - 4x) = \frac{5 - (5 - 4x)}{4} = \frac{4x}{4} = x
    \\\ \\\
    f(f^{-1}(x)) = f^{-1}(f(x))
    \end{gather*}
    $$
...
19. *$ f(x) = x^3 - 1 $*
    ...
    *验证 $ f(f^{-1}(x)) = f^{-1}(f(x)) $*
    ...
    \\\ \\\
    f^{-1}(f(x)) = f^{-1}(x^3 - 1) = \sqrt[3]{x^3 + 1 - 1} = x
    \\\ \\\
    f(f^{-1}(x)) = f^{-1}(f(x))
    \end{gather*}
    $$
...
20. *$ f(x) = x^2 + 1，x \geq 0 $*
    ...
    *求 $ f^{-1} $*
    ...
    y - 1 = x^2
    \\\ \\\
    \sqrt{y - 1} = \sqrt{x^2} = \mid x \mid = x \quad \text{因为} x \geq 0 \text{所以} \mid x \mid = x
    \\\ \\\
    y = \sqrt{x - 1} 
    \\\ \\\
    f^{-1}(x) = \sqrt{x - 1} 
    ...
    *验证 $ f(f^{-1}(x)) = f^{-1}(f(x)) $*
    $$
    \begin{gather*}
    f(f^{-1}(x)) = f(\sqrt{x-1}) = \sqrt{x-1}^2 + 1 = x - 1 + 1 = x
    \\\ \\\
    f^{-1}(f(x)) = f^{-1}(x^2 + 1) = \sqrt{x^2 + 1 - 1} = x
    \\\ \\\
    f(f^{-1}(x)) = f^{-1}(f(x))
    \end{gather*}
    $$
...
21. *$ f(x) = x^2，x \leq 0 $*
    ...
    *求 $ f^{-1} $*
    ...
    y = x^2
    \\\ \\\
    \sqrt{y} = \sqrt{x^2} = \mid x \mid = -x  \quad \text{因为} x \leq 0 \text{所以} \mid x \mid = -x
    \\\ \\\
    y = -\sqrt{x}
    \\\ \\\
    f^{-1}(x) = -\sqrt{x}
    ...
    *验证 $ f(f^{-1}(x)) = f^{-1}(f(x)) $*
    ...
    \\\ \\\
    f^{-1}(f(x)) = f^{-1}(x^2) = -\sqrt{x^2} = -(-x) = x \quad \text{因为原函数定义域是} x \leq 0，\text{所以} -()
    \\\ \\\
    f(f^{-1}(x)) = f^{-1}(f(x))
    \end{gather*}
    $$
...
22. *$ f(x) = x^{2/3}，x \geq 0 $*
    ...
    *验证 $ f(f^{-1}(x)) = f^{-1}(f(x)) $*
    $$
    \begin{gather*}
    f(f^{-1}(x)) = f(x^{3/2}) = (x^{3/2})^{2/3} = x
    \\\ \\\
    f^{-1}(f(x)) = f^{-1}(x^{2/3}) = (x^{2/3})^{3/2} = x 
    \\\ \\\
    f(f^{-1}(x)) = f^{-1}(f(x))
    \end{gather*}
    $$
...
23. *$ f(x) = -(x - 2)^2，x \leq 2 $*
    ...
    *求 $ f^{-1} $*
    ...
    y = -(x - 2)^2
    \\\ \\\
    \sqrt{-y} = \sqrt{(x - 2)^2} = \mid \sqrt{(x - 2)^2} \mid = -\sqrt{(x - 2)^2} \quad \text{因为} x \leq 2, 所以\mid \sqrt{(x - 2)^2} \mid = -\sqrt{(x - 2)^2}
    \\\ \\\
    \sqrt{-y} - 2 = -x
    \\\ \\\
    y = 2 - \sqrt{-x}
    ...
    *验证 $ f(f^{-1}(x)) = f^{-1}(f(x)) $*
    $$
    \begin{gather*}
    f(f^{-1}(x)) = f(2 - \sqrt{-x}) = -(2 - \sqrt{-x} - 2)^2 = -(-\sqrt{-x})^2 = -(-x) = x
    \\\ \\\
    f^{-1}(f(x)) = f^{-1}(-(x-2)^2) = 2 - \sqrt{-(-(x-2)^2)} = 2 - \sqrt{(x - 2)^2} = 2 - \mid (x - 2) \mid = 2 - (-x + 2) = 2 + x - 2 = x
    \\\ \\\
    \text{因为} x \leq 2 所以 \mid (x - 2) \mid = -(x - 2) = -x + 2
    \\\ \\\
    f(f^{-1}(x)) = f^{-1}(f(x))
    \end{gather*}
    $$
...
24. *$ f(x) = x^2 + 2x + 1，x \geq -1 $*
    ...
    *求 $ f^{-1} $*
    ...
    y = (x + 1)^2
    \\\ \\\
    \sqrt{y} = \sqrt{(x + 1)^2} = \mid (x + 1) \mid = x + 1 \quad 因为 x \geq 1 所以 \mid (x + 1) \mid = x + 1
    \\\ \\\
    y = \sqrt{x} - 1 \quad x,y交换
    \\\ \\\
    f^{-1}(x) = \sqrt{x} - 1
    \end{gather*}
    $$
    *验证 $ f(f^{-1}(x)) = f^{-1}(f(x)) $*
    $$
    \begin{gather*}
    f(f^{-1}(x)) = f(\sqrt{x} -1) = (\sqrt{x} -1 + 1)^2 = \mid x \mid = x;
    \\\ \\\
    f^{-1}(f(x)) = f^{-1}((x+1)^2) = \sqrt{(x+1)^2} - 1 = \mid x + 1\mid -1 = x + 1 -1 = x
    \\\ \\\
    \text{因为} x \leq 2 所以 \mid (x - 2) \mid = -(x - 2) = -x + 2
    \\\ \\\
    f(f^{-1}(x)) = f^{-1}(f(x))
